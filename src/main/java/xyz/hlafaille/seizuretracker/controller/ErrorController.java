...
public class ErrorController
    ...
    public String handleError(HttpServletRequest request, Model model) {
        ...
        Object statusCodeObj = request.getAttribute(
        ...
        if (statusCode == HttpStatus.NOT_FOUND.value()) {
            ...
            funnyCardSubtitle =
                "Someone let the gremlins into our servers again. We're on it!";
            errorMessage =
                "An internal server error has occurred. Please create a bug report.";
